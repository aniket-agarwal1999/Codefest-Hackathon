...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 31 17:32:58 2018
...
from sklearn.ensemble import GradientBoostingRegressor   #learning_rate, n_
regressor = GradientBoostingRegressor(n_estimators=1000)
regressor.fit(X_train, y_train)
predicted = regressor.predict(X_valid)
from sklearn import metrics
metrics.mean_squared_error(y_valid, predicted)
